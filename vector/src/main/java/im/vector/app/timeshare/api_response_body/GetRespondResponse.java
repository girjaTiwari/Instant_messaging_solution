...
public class GetRespondResponse {
    String Status,Msg,ResponseCode;

    public List<Respond> responds = new ArrayList<>();

    public GetRespondResponse(String status, String msg, String responseCode, List<Respond> responds) {
        Status = status;
        Msg = msg;
