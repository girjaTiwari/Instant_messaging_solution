...
sealed interface RegisterAction {
    ...
    data class CreateAccount(val firstname:String,val lastname:String,val profilename:String,val username: String, val password: String, val initialDeviceName: String) : RegisterAction
