...
sealed interface OnboardingAction : VectorViewModelAction {
    ...
    sealed interface AuthenticateAction : OnboardingAction {
        data class Register(val firstname:String,val lastname:String,val profilename:String,val username: String, val password: String,val phone: String, val initialDeviceName: String) : AuthenticateAction
