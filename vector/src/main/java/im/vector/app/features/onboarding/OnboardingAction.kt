...
sealed interface OnboardingAction : VectorViewModelAction {
    ...
    sealed interface AuthenticateAction : OnboardingAction {
        data class Register(val firstname:String,val lastname:String,val username: String,val email: String,val password: String,val phone: String, val initialDeviceName: String) : AuthenticateAction
        data class RegisterWithMatrixId(val firstname:String,val lastname:String,val matrixId: String,val email: String,val password: String,val phone: String, val initialDeviceName: String) : AuthenticateAction
